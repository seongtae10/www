 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.508863429572, 126.88840141574),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.508863429572, 126.88840141574); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.1405079, 127.0558665),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.1405079, 127.0558665); 
   ...
   var container3 = document.getElementById('home3');
   var options3 = {
       center: new daum.maps.LatLng(37.479278527043,126.87637391137),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.479278527043,126.87637391137); 
