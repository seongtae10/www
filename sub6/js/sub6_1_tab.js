...
$(document).ready(function(){
    ...
    $('.tabs .tab1').css('background','#fff').css('color','#d81408'); //첫번째 탭메뉴 활성화
        ...
        if(scroll>10 && onoff==false){//스크롤300까지 내리면
            $('.tabs .contlist').hide();
    ...
    $('.tabs .tab').click(function(e){
          ...
          $(this).css('background','#fff').css('color','#d81408'); // 클릭한 해당 탭메뉴만 활성화
